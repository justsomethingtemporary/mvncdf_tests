...
with st.echo(code_location='below'):
    ...
    dimension = st.slider("Dimension of multivariate gaussian distribution", 1, 500, value=5, step=1)
    sigma = make_spd_matrix(n_dim=dimension, random_state=1)
    max_val = st.slider("Maximum value achieved", -10, 10, value=0, step=0.01)
